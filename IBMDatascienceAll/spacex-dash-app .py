...
def update_output(selected_option, slider_option):
    ...
    filtered_df = spacex_df[
        (spacex_df['Payload Mass (kg)'] >= slider_option[0]) &
        (spacex_df['Payload Mass (kg)'] <= slider_option[1])
    ]
    ...
    # Specific site selected
        ...
        site_df = filtered_df[filtered_df['Launch Site'] == selected_option]
        ...
        fig2 = px.scatter(
            ...
            y='class',
            color='Booster Version Category',
            title=f'Correlation Between Payload and Launch Success for {selected_option}'
        )
